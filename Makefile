...
.PHONY: help setup setup-backend setup-frontend app backend backend-reload frontend batch batch-list batch-file health clean db-up db-down
...
frontend:
	@test -d $(FRONTEND_DIR)/node_modules || $(MAKE) setup-frontend
